...
% Create buses for sensors
blk = [modelName,'/Sensors and Environment/Driving Radar Data Generator'];
drivingRadarDataGenerator.createBus(blk);

blk = [modelName,'/Sensors and Environment/Vision Detection Generator'];
visionDetectionGenerator.createBus(blk);
